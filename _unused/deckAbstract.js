var DeckA = (function () {
	...
	function _card(i, text = '') {
		...
		var self = { text: text, i: i, rank: rank, suit: suit, pos: i, elem: elem, 
	...
	DeckA.ease = ease;
	DeckA.modules = { bysuit: bysuit, fan: fan, intro: intro, poker: poker, shuffle: shuffle, sort: sort, flip: flip };
	DeckA.Card = _card;
	DeckA.prefix = prefix;
