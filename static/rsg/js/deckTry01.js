...
var Deck = (function (deckGenerator=Deck52) {
  // 'use strict';
  ...
  function observable(target) {
	...
	function DeckCatan(jokers=20) {
    // init cards array
		var cards = new Array(jokers ? 55 : 52);
		console.log('creating standard deck...')
  ...
  Deck52.animationFrames = animationFrames;
  Deck52.ease = ease;
  Deck52.modules = { bysuit: bysuit, fan: fan, intro: intro, poker: poker, shuffle: shuffle, sort: sort, flip: flip };
  Deck52.Card = _card;
  Deck52.prefix = prefix;
  Deck52.translate = translate;
