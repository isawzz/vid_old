...
var DeckCatan = (function () {
  ...
  function DeckCatan(jokers) {
    // init cards array
    var cards = new Array(jokers ? 55 : 52);

    var cardElem = createElement('div');
    var self = observable({ mount: mount, unmount: unmount, cards: cards, cardElem: cardElem });
    var $root;
  ...
  DeckCatan.animationFrames = animationFrames;
  DeckCatan.ease = ease;
  DeckCatan.modules = { bysuit: bysuit, fan: fan, intro: intro, poker: poker, shuffle: shuffle, sort: sort, flip: flip };
  DeckCatan.Card = _card;
  DeckCatan.prefix = prefix;
  DeckCatan.translate = translate;
	console.log('hallo!')
  return DeckCatan;
})();
